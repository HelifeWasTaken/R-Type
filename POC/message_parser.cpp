...
void poc_message_parser()
{
    ...
    boost::shared_ptr<rtype::net::SyncMessage> sync_msg2 =
    rtype::net::Message::deserialize<rtype::net::SyncMessage>(buffer);
    ...
    boost::shared_ptr<rtype::net::IMessage> msg =
    rtype::net::parse_message(buffer); assert(msg->code() ==
    rtype::net::message_code::SYNC_MSG);

    boost::shared_ptr<rtype::net::SyncMessage> msg2 =
    rtype::net::parse_message<rtype::net::SyncMessage>(buffer);
    assert(msg2->code() == rtype::net::message_code::SYNC_MSG);

    boost::shared_ptr<rtype::net::UpdateMessage> msg3 =
    rtype::net::parse_message<rtype::net::UpdateMessage>(buffer); assert(msg3 ==
    nullptr);
