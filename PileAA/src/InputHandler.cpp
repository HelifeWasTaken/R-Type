...
namespace paa {
    ...
    unsigned int ControllerJoystick::id() const
    { return _id; }
    ...
    ControllerKeyboard& ControllerKeyboard::setKey(const unsigned int& button, const Keyboard::Key& key)
    { _keys_to_button[button] = key; return *this; }

    ControllerKeyboard& ControllerKeyboard::setAxis(const Joystick::Axis& axis, const Keyboard::Key& positiveAxis, const Keyboard::Key& negativeAxis)
    { _keys_to_axis[axis * 2] = positiveAxis; _keys_to_axis[axis * 2 + 1] = negativeAxis; return *this; }

    unsigned int ControllerKeyboard::id() const
    { return -1; }

    bool ControllerKeyboard::isConnected() const
    { return true; }

    bool ControllerKeyboard::isDisconnected() const
    { return false; }

    bool ControllerKeyboard::isActive() const
    { return true; }
