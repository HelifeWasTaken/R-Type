...
namespace paa {
    ...
    public:
        ...
        void put(const unsigned int& x, const unsigned int& y, const Color& color)
        {
            ...
            const paa::u8 rgba[4] = {
                static_cast<paa::u8>(color.r),
                static_cast<paa::u8>(color.g),
                static_cast<paa::u8>(color.b),
        ...
        static Texture generateDefaultTexture(const unsigned int& width=100,
        ...
        static Image generateDefaultImage(const unsigned int& width=100,
                                              const unsigned int& height=100)
        {
