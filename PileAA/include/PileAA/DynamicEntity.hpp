...
namespace paa {
    ...
    public:
         ...
         * @param id 
         */
        DynamicEntity(const entity_id_t& id) : _entity(entity_t(id)) {}
        /**
         * @brief Construct a new Dynamic Entity object
         * @param entity 
         */
        DynamicEntity(const entity_t& entity) : _entity(entity) {}
         ...
         */
        const entity_t& getEntity() const
        { return _entity; }
         ...
         */
        void kill()
        { _registry.kill_entity(_entity); _entity = entity_t(); }

        /**
         * @brief Tells if the entity is valid
         */
        bool isAlive() const
        { return _registry.is_alive(_entity); }
